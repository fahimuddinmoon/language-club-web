...
const CategoryDetail4 = () => {
    ...
    useEffect(() => {
        const info = allData.filter(data => data.language === 'German')
        setSameData(info)
    }, [allData])

    return (
        <div className={sameData.length === 0?'px-5 pt-24 h-screen' : 'w-full px-7 pt-24'}>
            <h3 className='text-3xl font-extrabold text-center pb-5 my-5'> All German Tutors</h3>
...
export default CategoryDetail4;